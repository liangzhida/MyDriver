...
public class SuijiAcitivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suiji_acitivity);
        initView();
        init();
        initlv();
        run = true;
    ...
    private void initlv() {
        ...
        lv.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                convertView = LayoutInflater.from(SuijiAcitivity.this).inflate(R.layout.item_comment, parent, false);
                                        ...
                                        public void onCheckedChanged(RadioGroup group, int checkedId) {
                                            switch (checkedId) {
                                                case R.id.rb_a:
                                                    if (info.getResult().get(posion).getAnswer().equals("1")) {
                                                        posion++;
                                                        Toast.makeText(SuijiAcitivity.this, "回答正确!", Toast.LENGTH_SHORT).show();
                                                    } else {
...
//                                            Toast.makeText(ShunxuActivity.this, "d", Toast.LENGTH_SHORT).show();
                                    ...
                                    if (info.getResult().get(posion).getUrl().equals("")) {
                                        ...
                                        Glide.with(SuijiAcitivity.this).load(info.getResult().get(posion).getUrl() + "").into(imgshow);
                                    }
